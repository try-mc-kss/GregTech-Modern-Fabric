...
public class GTOreVeinEmiCategory extends EmiRecipeCategory {
    ...
    public GTOreVeinEmiCategory(ResourceLocation id, EmiRenderable icon) {
        super(id, icon);
    }

    public GTOreVeinEmiCategory(ResourceLocation id, EmiRenderable icon, EmiRenderable simplified) {
        super(id, icon, simplified);
    }

    public GTOreVeinEmiCategory(ResourceLocation id, EmiRenderable icon, EmiRenderable simplified, Comparator<EmiRecipe> sorter) {
