...
public class FluidPipeNetWalker extends PipeNetWalker<FluidPipeData, FluidPipeNet> {
    ...
    @NotNull
    @Override
    protected PipeNetWalker<FluidPipeData, FluidPipeNet> createSubWalker(FluidPipeNet pipeNet, Direction facingToNextPos, BlockPos nextPos, int walkedBlocks) {
    ...
    @Override
    protected void checkNeighbour(Node<FluidPipeData> pipeNode, BlockPos pipePos, Direction faceToNeighbour, @Nullable BlockEntity neighbourTile) {
