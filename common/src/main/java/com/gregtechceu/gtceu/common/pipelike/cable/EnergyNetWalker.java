...
public class EnergyNetWalker extends PipeNetWalker<CableData, EnergyNet> {
    ...
    @NotNull
    @Override
    protected PipeNetWalker<CableData, EnergyNet> createSubWalker(EnergyNet pipeNet, Direction facingToNextPos, BlockPos nextPos, int walkedBlocks) {
    ...
    @Override
    protected void checkNeighbour(Node<CableData> pipeNode, BlockPos pipePos, Direction faceToNeighbour, @Nullable BlockEntity neighbourTile) {
