...
public class LaserNetWalker extends PipeNetWalker<LaserPipeNet.LaserData, LaserPipeNet> {
    ...
    @Nonnull
    @Override
    protected LaserNetWalker createSubWalker(LaserPipeNet world, Direction facingToNextPos, BlockPos nextPos, int walkedBlocks) {
    ...
    @Override
    protected void checkNeighbour(Node<LaserPipeNet.LaserData> pipeNode, BlockPos pipePos, Direction faceToNeighbour, @Nullable BlockEntity neighbourTile) {
